package com.meettingfilm.testng.config;
...
public class ExtentTestNGIReporterListener implements IReporter {
    //生成的路径以及文件名
    private static final String OUTPUT_FOLDER = "backend_testng/report/";
    private static final String FILE_NAME = "index.html";

    private static final String REPORT_NAME = "Chuck的测试报告";
